 ...
 * Compile using:
 *
 *      gcc ./allow_net_bind_service.c -o allow_net_bind_service -lcap-ng
 *
 ...
 * processes:
 *
 *	./allow_net_bind_service /bin/bash
 *
 * Verifying that it works:
 *
 * From the bash spawed by allow_net_bind_service run
 *
 *	cat /proc/$$/status
 *
...
static void allow_net_bind_service_cap(int cap)
{
	int rc;
...
int main(int argc, char **argv)
{
	...
	allow_net_bind_service_cap(CAP_NET_BIND_SERVICE);
